...
?>
  <body>
    ...
    <main>
      <div class="r80">
        <section class="columns" id="ToC">
          <h2><img src="../images/meeting.svg" alt="" />Table of contents</h2>
          <div class="sectionContent" style="flex-flow: column;">
            <ul class="toc">
              <li><a href="#whatIs">What is the Tacoma Film Alliance?</a></li>
              <li><a href="#whyUse">Why use the Tacoma Film Alliance website?</a></li>
              <li><a href="#crappySMSite">Are you just trying to create another crappy social media site?</a></li>
              <li><a href="#findMe">How can people find me for their next project?</a></li>
              <li><a href="#slingshot">What's the "Slingshot"</a></li>
              <li><a href="#wam">What's the WAM?</a></li>              
              <li><a href="#updateProfile">How do I update my profile?</a></li>
              <li><a href="#enteredData">What do we do with the data that you enter?</a></li>
              <li><a href="#profilePic">How do I change my profile picture?</a></li>
            </ul>
          </div>
        </section>
        <section class="columns" id="generalHelp">
          ...
          <div class="sectionContent" style="flex-flow: column;">
          <div class="row" id="whatIs" tabindex="-1">
            ...
            <div class="row" id="whyUse" tabindex="-1">
            ...
            <div class="row" id="crappySMSite" tabindex="-1">
            ...
            <div class="row" id="wam" tabindex="-1">
        ...
        <section class="columns" id="siteUsage">
          ...
          <div class="sectionContent" style="flex-flow: column;">  
            <div class="row" id="updateProfile" tabindex="-1">
              <h3>How do I update my profile?</h3>
              <p>
                In the top level navigation, click on 'Account'
                <span class="imageContainer">
                  <img src="../images/help_myacct.jpg" alt="" />
                </span>
                Once that page loads, in the sub-level tabs, find "My Info", and you'll see a form that will allow you to change all of your personal information.  
                <span class="imageContainer">
                  <img src="../images/help_myinfo.jpg" alt="" />
                </span>
            ...
            <div class="row" id="enteredData" tabindex="-1">
            ...
            <div class="row" id="profilePic" tabindex="-1">
              <h3>How do I change my profile picture</h3>
              <p>
                Your profile picture is displayed to you on all of the TFA website pages.  In order to change it, click on the circular avatar that displays.
                <span class="imageContainer">
                  <img src="../images/help_profile_pic.jpg" alt="" />
                </span>
                Once you've clicked the avatar, a dialog will display asking you to select the photo that you want to upload.
                <span class="imageContainer">
