<?php require('../../core/config.php');  
	...
	$memlist->execute(array(':memberID' => $memberID));
	$members = array();
	...
	$meminfolist->execute(array(':memberID' => $memberID));
	$meminfo = array();
	...
	$postlist->execute(array(':memberID' => $memberID));
	$posts = array();
	...
	$messageslist->execute(array(':memberID' => $memberID));
	$messages = array();
	...
	$filmslist->execute(array(':memberID' => $memberID));
	$films = array();
	...
	$projectlist->execute(array(':memberID' => $memberID));
	$projects = array();
	...
	$homepagelist->execute(array(':memberID' => $memberID));
	$homepage = array();
	...
	$uploadslist->execute(array(':memberID' => $memberID));
	$uploads = array();
	...
	$resourceslist->execute(array(':memberID' => $memberID));
	$resources = array();
